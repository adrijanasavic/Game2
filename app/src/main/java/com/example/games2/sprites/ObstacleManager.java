...
import com.example.games2.GameManager;
import com.example.games2.GameManagerCallback;
...
public class ObstacleManager implements ObstacleCallback {
    ...
    public ObstacleManager(Resources resources, int screenHeight, int screenWidth, GameManager callback) {
